...
if($sql)
                    {
                        echo '<script>alert("Data Added Successfully");window.location="prg4view.php"</script>';
                    }
                    else
                    {
    ...
    echo '<script>alert("Passport Number Already Present");window.location="prg4add.php"</script>';
}
}
?>
</body>
