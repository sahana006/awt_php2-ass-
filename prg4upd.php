...
include 'con_db.php';
    if($_POST)
    {
        ...
        if($row==0){
            echo '<script>alert("Passport Number not found");window.location="prg4update.php"</script>';
        }
    }
?>
...
if($sql)
                    {
                        echo '<script>alert("Data Updated Successfully");window.location="prg4view.php"</script>';
                    }
                    else
                    {
