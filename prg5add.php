...
if($sql)
                    {
                        echo '<script>alert("Data Added Successfully");window.location="prg5view.php"</script>';
                    }
                    else
                    {
...
{
  echo '<script>alert("Minimum 500 Rupees should be maintained");window.location="prg5add.php"</script>';  
}
}
else{
    echo '<script>alert("Account Number Already Present");window.location="prg5.php"</script>';
}
}
?>
</body>
